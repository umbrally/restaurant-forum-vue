<template>
  <div class="container py-5">
    <UserProfileCard :initial-user-profile="userProfile" :current-user="currentUser" @after-add-following="addFollowing" @after-delete-following="deleteFollowing"/>
...
methods: {
  fetchUser(){
    this.userProfile.id = dummyData.profile.id
    this.userProfile.name=dummyData.profile.name
    this.userProfile.email=dummyData.profile.email
    this.userProfile.image=dummyData.profile.image
    this.userProfile.commentCounts=dummyData.profile.Comments.length
    this.userProfile.favoritedRestaurantsCounts=dummyData.profile.FavoritedRestaurants.length
    this.userProfile.followingsCounts=dummyData.profile.Followings.length
    this.userProfile.followersCounts=dummyData.profile.Followers.length
    this.userProfile.isFollowed=dummyData.profile.isFollowed
    this.userFollowings = dummyData.profile.Followings
    this.userFollowers = dummyData.profile.Followers
    this.commentRestaurants = dummyData.profile.Comments
